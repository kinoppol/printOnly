...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_file_size' => 'ขนาดไฟล์ใหญ่เกินไป',
        'min_file_size' => 'ขนาดไฟล์เล็กเกินไป',
        'accept_file_types' => 'ชนิดของไฟล์ไม่รองรับ',
        'max_number_of_files' => 'จำนวนไฟล์มากเกินกำหนด',
        'invalid_file_type' => 'ชนิดของไฟล์ไม่ถูกต้อง',
        'max_width' => 'Image exceeds maximum width',
        'min_width' => 'Image requires a minimum width',
        'max_height' => 'Image exceeds maximum height',
        'min_height' => 'Image requires a minimum height',
        'abort' => 'การอัพโหลดถูกยุติ',
